...
namespace ImGui
{
    ...
    void PlatformInit(const std::string& backend_name)
    {
        ...
        Renderer::main_target = ResourceManager::Create<RenderTarget>("EditorWindow");
        ...
        const ResourceRef<Texture> render_buffer = ResourceManager::Create<Texture>(render_buffer_settings, SamplerSettings{});
        ...
        const ResourceRef<Texture> depth_buffer = ResourceManager::Create<Texture>(depth_buffer_settings, SamplerSettings{});
